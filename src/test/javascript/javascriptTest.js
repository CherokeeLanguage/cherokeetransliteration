...
*
* when the tests are run they will output any failures to the transliterate textarea.
*/
$(function() {
    function appender(value, value2) {
        if (value == value2) {
//            $('#transliteration').append("true");
//            $('#transliteration').append('\n');
        } else {
            $('#transliteration').append(value).append(" != ").append(value2);
            $('#transliteration').append('\n');
        }
    }
    ...
    function runTests() {
        ...
        appender('Ꮢ##Ꮤ', tsalagiToSyllabary('svkta'));
    ...
    function testCH() {
        appender('Ꮸ', tsalagiToSyllabary('chv'));
